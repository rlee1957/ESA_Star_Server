...
<br>
<div class="login">
	<form id="login3" action="https://www.esastar.com/web_services/web_service.php" target="_blank" method="post"> 
	...
	<input type="hidden" name="application_name" id="application_name" value="<?php echo($application_name); ?>" />
	<input type="hidden" name="application_key" id="application_key" value="<?php echo($application_key); ?>" />
